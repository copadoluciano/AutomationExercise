...
Feature: Loans
  ...
  #       | 4  | Custom    | USER_EMAIL_01 | USER_PASSWORD | SECRET_01 | lend      | Fixed    | BCH      | 0.1    | 02           | 5         | days      | 1         | minutes          | 2                | 10         | ETH             | 9               | daily    | 0        | 11               | USER_EMAIL_02 | USER_PASSWORD | SECRET_02 |
  #       | 5  | Custom    | USER_EMAIL_01 | USER_PASSWORD | SECRET_01 | borrow    | Open     | BCH      | 0.1    | 02           | 5         | days      | 1         | minutes          | 2                | 10         | ETH             | 9               | daily    | 0        | 11.5             | USER_EMAIL_02 | USER_PASSWORD | SECRET_02 |
  ...
  #     Examples:
  #       | ID | TypeToken | email         | password      | secret         | operation | typeLoan | currency | amount | counterparty | aprAmount | duration1 | duration2 | offerExpiration1 | offerExpiration2 | collateral | collateralAsset | collateralLimit | frecuency | repayFee | refundCollateral | cp_email      | cp_password   | cp_secret      |
  #       | 6  | Custom    | USER_EMAIL_09 | USER_PASSWORD | SECRET_01 | lend      | Open     | ETH      | 0.1    | 02           | 5         | days      | 1         | minutes          | 1              | 100        | SHIB            | 99.5            | weekly    | 0        | 100.5            | USER_EMAIL_02 | USER_PASSWORD | SECRET_02 |
...
#   Examples:
#     | ID | TypeToken | email         | password      | secret    | operation | typeLoan | currency | amount | counterparty | aprAmount | duration1 | duration2 | offerExpiration1 | offerExpiration2 | collateral | collateralAsset | collateralLimit | frecuency | repayFee | refundCollateral | cp_email      | cp_password   | cp_secret |
#     | 9  | Custom    | USER_EMAIL_01 | USER_PASSWORD | SECRET_01 | borrow    | Open     | ETH      | 0.2    | 02           | 0         | 1         | minutes   | 1                | 5                | 0          | weekly          | SHIB            | 100       | 99.5     | 100.5            | USER_EMAIL_02 | USER_PASSWORD | SECRET_02 |
#     | 10 | Custom    | USER_EMAIL_01 | USER_PASSWORD | SECRET_01 | lend      | Fixed    | ETH      | 0.1    | 02           | days      | 1         | minutes   | 1                | 10               | 0          | weekly          | SHIB            | 100       | 99.5     | 100.5            | USER_EMAIL_02 | USER_PASSWORD | SECRET_02 |