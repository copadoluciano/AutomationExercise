...
@TEST_LM-8825
  Scenario Outline: [E2E] <ID>- Loans > Validate Container
    ...
    And the time is between 16 and 17 Argentina
    ...
    Examples:
      ...
      | 3  | USER_EMAIL_03 | USER_PASSWORD | SECRET_03_DEMO | borrow    | Fixed    | ETH      | 0.1    | 04           | 5         | days      | 1         | minutes          | 2                | 100        | SHIB            | 99.5            | daily    | 0        | 100.5            | USER_EMAIL_04 | USER_PASSWORD | SECRET_04_DEMO |
...
@TEST_LM-8826
  Scenario Outline: [E2E] <ID>- Loans > Create & Accept Order with <TypeToken> Token and Collateral <collateral>
    ...
    Examples:
      ...
      | 4  | Custom    | USER_EMAIL_01 | USER_PASSWORD | SECRET_01_DEMO | lend      | Fixed    | BCH      | 0.1    | 02           | 5         | days      | 1         | minutes          | 1                | 10         | ETH             | 9               | weekly    | 0        | 11               | USER_EMAIL_02 | USER_PASSWORD | SECRET_02_DEMO |
      | 5  | Custom    | USER_EMAIL_01 | USER_PASSWORD | SECRET_01_DEMO | borrow    | Open     | BCH      | 0.1    | 02           | 5         | days      | 1         | minutes          | 1                | 10         | ETH             | 9               | weekly    | 0        | 11.5             | USER_EMAIL_02 | USER_PASSWORD | SECRET_02_DEMO |
  ...
  Scenario Outline: [E2E] <ID>- Loans > Counterparty Reject Order
    ...
    Examples:
      | ID | TypeToken | email         | password      | secret         | operation | typeLoan | currency | amount | counterparty | aprAmount | duration1 | duration2 | offerExpiration1 | offerExpiration2 | collateral | collateralAsset | collateralLimit | frecuency | repayFee | refundCollateral | cp_email      | cp_password   | cp_secret      |
      | 6  | Custom    | USER_EMAIL_01 | USER_PASSWORD | SECRET_01_DEMO | lend      | Open     | ETH      | 0.1    | 02           | 5         | days      | 1         | minutes          | 1                | 100        | SHIB            | 99.5            | weekly    | 0        | 100.5            | USER_EMAIL_02 | USER_PASSWORD | SECRET_02_DEMO |
  ...
  Scenario Outline: [E2E] <ID>- Loans > Maker Cancel Order
    ...
    Examples:
      ...
      | 7  | Custom    | USER_EMAIL_01 | USER_PASSWORD | SECRET_01_DEMO | borrow    | Open     | ETH      | 0.1    | 02           | 5         | days      | 1         | minutes          | 1                | 100        | SHIB            | 99.5            | weekly    | 0        | 100.5            |
...
# | lend      | 2        | LTC      | 0.01   | 10           | 15        | days      | 5         | hours            | 1                | 100        | BCH             | 0.5             | weekly    |
# | lend      | 0        | TOKE     | 0.0001 | 10           | 15        | days      | 5         | hours            | 1                | 100        | SHIB            | 0.5             | weekly    |
