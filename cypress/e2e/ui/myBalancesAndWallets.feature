Feature: My Balances and Wallets
    ...
    Scenario Outline: My Wallets - Validate Static Elements
        ...
        Examples:
            ...
            | 1  | USER_EMAIL_17 | USER_PASSWORD | SECRET_17 |
#Monitoring
    @TEST_LM-8875 @TESTSET_LM-9081 @monitoring
